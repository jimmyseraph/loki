...
export function initJSONPathExtractorElement(
  key: string,
  label: string,
): Element {
...
const JSONPathExtractorForm: React.FC<ScriptFormProps> = (
  ...
  return (
    <Form
      form={form}
      name="json_path_extractor_form"
      autoComplete="off"
      onFinish={handleFinish}
    >
      <Row>
        <Col>
          <h3>JSON Path Extractor</h3>
        </Col>
      </Row>
          ...
          <Form.Item
            ...
            initialValue={
              getParamElement(xmlNode!, 'match_no') === null
                ? 1
                : parseInt(
                    getParamElement(xmlNode!, 'match_no')
