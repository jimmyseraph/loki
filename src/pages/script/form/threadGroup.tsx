        ...
        <Col span={10}>
          ...
          <Form.Item
            ...
            initialValue={parseInt(
              getParamElement(xmlNode!, 'num_threads')?.innerHTML as string,
            )}
            rules={[
          ...
          <Form.Item
            ...
            initialValue={parseInt(
              getParamElement(xmlNode!, 'ramp_time')?.innerHTML as string,
            )}
            rules={[
              { required: true, message: 'Need valid number' },
          ...
          <Form.Item
            ...
            label="Loop Count"
            initialValue={parseInt(
              getParamElement(xmlNode!, 'num_loop')?.innerHTML as string,
            )}
            rules={[
              { required: true, message: 'Need valid number' },
              { min: 1, message: 'Cannot less than 1', type: 'number' },
          ...
          <Form.Item
            ...
            label="Scheduler"
            initialValue={
              (getParamElement(xmlNode!, 'scheduler')?.innerHTML as string) ===
              'true'
            }
            valuePropName="checked"
          >
          ...
          <Form.Item
            ...
            label="Duration"
            initialValue={parseInt(
              getParamElement(xmlNode!, 'duration')?.innerHTML as string,
            )}
            rules={[
              { required: true, message: 'Need valid number' },
              { min: 0, message: 'Cannot less than 0', type: 'number' },
