...
export function initResponseAssertionElement(
  key: string,
  label: string,
): Element {
...
const ResponseAssertionForm: React.FC<ScriptFormProps> = (
      ...
      <Row gutter={8}>
        <Col span={20}>
          <Form.Item
            name="field"
            initialValue={
              getParamElement(xmlNode!, 'field') === null
                ? 'body'
                : (getParamElement(xmlNode!, 'field')?.textContent as string)
            }
          >
      ...
      <Row gutter={8}>
        <Col span={10}>
          <Form.Item
            ...
            label="Match Rule"
            initialValue={
              getParamElement(xmlNode!, 'rule') === null
                ? ''
                : (getParamElement(xmlNode!, 'rule')?.textContent as string)
            }
          >
      ...
      <Row gutter={8}>
        <Col span={10}>
          <Form.Item
            name="pattern"
            initialValue={
              getParamElement(xmlNode!, 'pattern') === null
                ? ''
                : getParamElement(xmlNode!, 'pattern')?.textContent
            }
          >
