...
export function initRegExpExtractorElement(
  key: string,
  label: string,
): Element {
...
const RegExpExtractorForm: React.FC<ScriptFormProps> = (
  props: ScriptFormProps,
) => {
  ...
  return (
    <Form
      form={form}
      name="regexp_extractor_form"
      autoComplete="off"
      onFinish={handleFinish}
    >
      <Row>
        <Col>
          <h3>RegExp Extractor</h3>
        </Col>
      </Row>
      ...
      <Row gutter={8}>
        <Col span={15}>
          <Form.Item
            ...
            initialValue={
              getParamElement(xmlNode!, 'name') === null
                ? ''
                : (getParamElement(xmlNode!, 'name')?.textContent as string)
            }
          >
      ...
      <Row gutter={8}>
        <Col span={15}>
          <Form.Item
            ...
            initialValue={
              getParamElement(xmlNode!, 'exp') === null
                ? ''
                : (getParamElement(xmlNode!, 'exp')?.textContent as string)
            }
          >
            <Input disabled={!enabled} />
          </Form.Item>
      ...
      <Row gutter={8}>
        <Col span={15}>
          <Form.Item
            ...
            initialValue={
              getParamElement(xmlNode!, 'match_no') === null
                ? 1
                : parseInt(
                    getParamElement(xmlNode!, 'match_no')?.innerHTML as string,
                  )
            }
          >
