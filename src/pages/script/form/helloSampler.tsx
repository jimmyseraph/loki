...
const HelloSamplerForm: React.FC<ScriptFormProps> = (
      ...
      <Row gutter={24} style={{ marginTop: '1.5em' }}>
        <Col span={10}>
          ...
          <Divider orientation="left" plain>
            Hello Sampler Properties
          </Divider>
          <Form.Item
            name="name"
            label="Name"
            initialValue={
              getParamElement(xmlNode!, 'name')?.innerHTML as string
            }
          ...
          <Form.Item
            ...
            initialValue={parseInt(
              getParamElement(xmlNode!, 'sleep')?.innerHTML as string,
            )}
            rules={[
